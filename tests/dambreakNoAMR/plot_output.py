...
def plot_single_frame(plotfile_path, output_prefix="", hl=0.005, hr=0.001, x0=5.0, L=10.0):
    ...
    gs = gridspec.GridSpec(2, 1, height_ratios=[2.0, 4.0], hspace=0.40)
    ...
    for rect in get_meshblock_rects(ds):
...
def main():
    ...
    parser.add_argument("--hl", type=float, default=0.5, help="Upstream water depth")
    parser.add_argument("--hr", type=float, default=0.1, help="Downstream water depth")
    parser.add_argument("--x0", type=float, default=25.6, help="Initial dam location")
    parser.add_argument("--L", type=float, default=51.2, help="Domain extent")
