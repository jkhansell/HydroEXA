...
# Grid Dimensions
nx, ny = 100, 16  # High resolution in x, coarse in y (1D problem)
dx, dy = 0.1, 0.1  # 1-meter spatial resolution
x_ll, y_ll = 0.0, 0.0

# Physics Parameters
z_flat = 0.0          # Flat bathymetry (m)
h_L = 0.005             # High water depth left of dam (m)
h_R = 0.001             # Low water depth right of dam (m)
...
print(f"Water Depth (h)   : Left={h_L:.3f} m | Right={h_R:.3f} m")
