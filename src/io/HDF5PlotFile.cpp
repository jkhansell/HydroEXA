// HDF5PlotFile.cpp
// Multi-level HDF5 plotfile writer using AMReX's HDF5 plotfile format.
// Requires AMReX built with USE_HDF5=TRUE and parallel HDF5.
// Extracted from IOHandler::WritePlotfile to decouple HDF5 I/O
    ...
    const std::string& compression)
{
    ...
    // 5. Fire parallel HDF5 output dump sequence
